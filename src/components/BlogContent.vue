<template>
                    ...
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            <img class="mr-4 w-16 h-16 rounded-full"
                                src="https://flowbite.com/docs/images/people/profile-picture-2.jpg" alt="Jese Leos">
                            <div>
                                <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">{{ content.author || "Badhusha" }}</a>
                                <p class="text-base text-gray-500 dark:text-gray-400">{{ content.designation || "CEO - devmorphix" }}</p>
                                <p class="text-base text-gray-500 dark:text-gray-400"><time pubdate
                                        datetime="2022-02-08" title="February 8th, 2022">{{ content.published_at }}</time></p>
                                <p class="text-base text-gray-500 dark:text-gray-400">{{ content.tag || "IoT" }}</p>
                            </div>
                        </div>
                    </address>
                    <h1
    ...
    <div v-html="content.html" class="container"></div>
