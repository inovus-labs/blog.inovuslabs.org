      ...
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
          <a href="/" class="flex items-center">
            <img src="/assets/logo_white.svg" class="h-12 mr-3" alt="Inovus Labs Logo" />
          </a>
        </div>
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
              <li class="mb-2">
                <a href="/" target="_blank" class="hover:underline ">Inovus Blogs</a>
              </li>
              <li class="mb-2">
                <a href="https://open.spotify.com/show/4QXEeK8ZWxewcXuLKCRR8R" target="_blank"
                  class="hover:underline ">Inovus Radio</a>
              </li>
              <li>
          ...
          <div class="col-span-2 sm:col-span-1">
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
              ...
              <li>
                <p class="opacity-50 cursor-not-allowed">IEDC Guidelines</p>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between items-center">
          ...
          <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            <a href="https://www.instagram.com/inovuslabs/" target="_blank"
            ...
            <a href="https://www.youtube.com/@inovuslabs_official" target="_blank"
              class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
